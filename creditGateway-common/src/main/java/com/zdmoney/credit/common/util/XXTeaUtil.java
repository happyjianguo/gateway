...
public class XXTeaUtil {
	 ...
	 * @return
	 */
	public static String xxteaDecrypt(String data, String key) {
	...
	private static long bytes2long(byte[] b, int index) {
		ByteBuffer buffer = ByteBuffer.allocate(8).order(ByteOrder.LITTLE_ENDIAN);
	...
	public static void main(String[] args) {
		String p2 = "{\"reqParam\":{\"customerId\":123,\"memo\":\"xxx\"}}";
		String afterEncrypt = xxteaEncrypt(p2, "1465366096114");
		System.out.println(afterEncrypt);
		afterEncrypt = "";
		String afterDecrypt = xxteaDecrypt(afterEncrypt, "1465366096114");
