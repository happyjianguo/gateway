...
//		String szSrc = bf.readLine();
	...
	/*	System.out.println("加密前的字符串:" + szSrc);
		...
		byte[] srcBytes = ThreeDes.decryptMode(keyBytes,
				ThreeDes.hex2byte(encode.getBytes()));
		System.out.println("解密后的字符串:" + (new String(srcBytes)));*/
		
		System.out.println(decrypt("B5E6277B7AE920CD3EE892A1B700DC65"));
		System.out.println(ThreeDes.decrypt("457271574B6235BB"));
