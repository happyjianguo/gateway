...
public class FrameWorkBaseController extends BaseController {
	...
	// @ResponseBody
	// public void sessionTimeOut(HttpServletRequest request,HttpServletResponse
	// response) {
	...
	// @ResponseBody
	// public String downloadBigFile(HttpServletRequest
	// request,HttpServletResponse response) {
	// AttachmentResponseInfo<Map<String,Object>> attachmentResponseInfo = new
	// AttachmentResponseInfo<Map<String,Object>>();
	// Map<String,Object> data = new HashMap<String,Object>();
	// attachmentResponseInfo.setAttachment(data);
	//
	// try {
	// Boolean downloadFileState =
	// (Boolean)request.getSession().getAttribute(request.getParameter("htmlDownloadFileToken"));
